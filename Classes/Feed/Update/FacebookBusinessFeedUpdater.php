...
/**
 * Class FacebookBusinessFeedUpdater
 * @package Pixelant\PxaSocialFeed\Feed\Update
 */
class FacebookBusinessFeedUpdater extends BaseUpdater
{
    /**
    ...
    /**
     * Update single facebookbusiness item
     *
     * @param Feed $feedItem
     * @param array $rawData
    ...
    protected function updateFeedItem(Feed $feedItem, array $rawData, Configuration $configuration): void
    {
        ...
        if ($feedUpdated < $updated) {
            $this->setFacebookBusinessData($feedItem, $rawData);
        ...
        // Call hook
        $this->emitSignal('beforeUpdateFacebookBusinessFeed', [$feedItem, $rawData, $configuration]);

        $this->addOrUpdateFeedItem($feedItem);
    }

    /**
     * Update facebookbusiness data
     *
     * @param Feed $feed
     * @param array $rawData
     */
    protected function setFacebookBusinessData(Feed $feed, array $rawData): void
    {
    ...
    protected function createFeedItem(array $rawData, Configuration $configuration): Feed
    {
        ...
        $feedItem->setType(Token::FACEBOOK_BUSINESS);
